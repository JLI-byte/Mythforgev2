...
/**
 * ReportWritingZone — the writing zone for a script or report — essays, articles, documents.
 *
 ...
 * project's writingMode is 'markdown'; see WritingZoneRenderer for the
...
export function ReportWritingZone({ content, onChange, onChangeImmediate, widget, onDragStart, onDeleteWidget, onDockChange, onManualSave, onAddAtCenter }: WritingZoneProps) {
