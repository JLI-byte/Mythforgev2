...
/**
 * ScreenplayWritingZone — the writing zone for a screenplay — film, TV or stage.
 *
 ...
 * project's writingMode is 'screenplay'; see WritingZoneRenderer for the
...
export function ScreenplayWritingZone({ content, onChange, onChangeImmediate, widget, onDragStart, onDeleteWidget, onDockChange, onManualSave, onAddAtCenter }: WritingZoneProps) {
