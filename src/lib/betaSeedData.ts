...
export function seedBetaData(store: WorkspaceState): void {
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['character'],
    name: 'Kael Morvant',
    type: 'character',
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['location'],
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['faction'],
    name: 'The Conclave',
    type: 'faction',
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['artifact'],
    name: 'Shard 7-C',
    type: 'artifact',
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['religion'],
  ...
  store.addEntity({
    ...
    projectId: proj1Id,
    worldId,
    categoryId: SEED_FOLDER['species'],
